...
public class VectorImmutable2DTests
{
    [Test]
    public void Add_01_Ok()
    {
        // Arrange
        var left = new VectorImmutable2D(3, 4);
        var right = new VectorImmutable2D(1, 2);
        
        // Act
        var result = left + right;
        
        // Assert
        Assert.That(result.ToString(), Is.EqualTo("(4,6)"));
    }
    ...
    public void Subtract_01_Ok()
    {
        ...
        // Assert
        Assert.That(result.ToString(), Is.EqualTo("(2,2)"));
    }
    
    [Test]
    public void MultiplyVectorWithValue_01_Ok()
    {
        // Arrange
        var vector = new VectorImmutable2D(3, 4);
        
        // Act
        var result = vector * 2;
        
        // Assert
        Assert.That(result.ToString(), Is.EqualTo("(6,8)"));
    }
    
    [Test]
    public void MultiplyValueWithVector_01_Ok()
    {
        // Arrange
        var vector = new VectorImmutable2D(3, 4);
    ...
    [Test]
    public void DivideVectorByValue_01_Ok()
    {
        // Arrange
        var vector = new VectorImmutable2D(6, 4);
        
        // Act
        var result = vector / 2;
        
        // Assert
        Assert.That(result.ToString(), Is.EqualTo("(3,2)"));
    }
    
    [Test]
    public void DivideVectorByValue_02_ThrowsExceptionOnDivisionByZero()
    {
        // Arrange
        var vector = new VectorImmutable2D(6, 4);
    ...
    [Test]
    public void DivideValueByVector_01_Ok()
    {
        // Arrange
        var vector = new VectorImmutable2D(6, 4);
    ...
    [Test]
    public void DivideValueByVector_02_ThrowsExceptionOnDivisionByZero()
    {
        // Arrange
        var vector = new VectorImmutable2D(6, 4);
